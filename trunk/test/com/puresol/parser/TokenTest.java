...
public class TokenTest extends TestCase {
	...
	public void testCreateByDefinitionClass() {
		...
		try {
			Token token = Token.createByDefinition(IdLiteral.class, 42, 123,
					21, text);
			...
			Assert.assertEquals(IdLiteral.class, token.getDefinition());

			IdLiteral definitionInstance = (IdLiteral) token
					.getDefinitionInstance();
			Assert.assertNotNull(definitionInstance);
			Assert.assertEquals(IdLiteral.class, definitionInstance.getClass());
