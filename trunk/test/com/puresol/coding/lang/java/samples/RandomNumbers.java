 ...
 * java.utils.Random is used to create base random numbers. A lot of different
 * methods are provided to create random numbers with mavericks (outlayers),
 * trends and steps for testing statistical calculations.
 * 
...
public class RandomNumbers {
	 ...
	 * java.util.Random generator is used to create base random numbers with
	 * normal and constant distribution for interager and double variables.
	 */
	private Random generator;

	/**
	 * This is the standard constructor for creating a new random number
	 * generator without setting a seed. The seed is generated regarding to the
	 * current system time.
	 */
	 ...
	 * 
	 * @param seed
	 *            is the random see to be used for reproducible random number
	 *            for test cases.
	 */
	...
	/**
	 * This method converts a value into an outlayer. The max size of the spike
	 * is specified.
	 * 
	 * @param d
	...
	/**
	 * This method returns a double random number in interval of [0.0, 1.0).
	 * 
	 ...
	 * 
	 * @param max
	 *            is the maximum int number for interval. Attention(!): This
	 *            number is the upper part of a semi open interval and therefore
	 *            never returned!
	 * 
	 * @return A int random number is returned.
	 * 
	...
	/**
	 * This method generates random number in gaussian distribution. The average
	 * for these random numbers is zero and the standard deviation is 1.
	 * 
	...
	/**
	 * This method generates random number in gaussian distribution. The average
	 * for these random numbers is set to avg and the standard deviation is
	 * stdDev.
	 * 
	 * @see java.util.Random
	 * 
	 ...
	 * 
	 * @param stdDev
	 *            is the standard deviation of the random numbers to get with a
	 *            large number of random numbers. This value must be greater
	 *            than 0.
	 * 
	 * @return A double variable with the random number is returned.
	 * 
	 ...
	 *            is the propability a outlayer (maverick) will be generated.
	 *            Values are exceptable from 0.0 to 1.0.
	 * 
	 * @param outlayerSize
	 ...
	 * 
	 * @param number
	 *            this is the number of datapoints to be generated. The number
	 *            has to be 2 or greater.
	 * 
	 * @param avgStart
	 *            is the average of the values at the begin of the trend series.
	 * 
	 * @param avgEnd
	 *            is the average of the values at the end of the trend series.
	 * 
	 * @param stdDevStart
	 *            is the standard deviation at the begin of the trend series.
	 *            This value must be greater than 0.
	 * 
	 * @param stdDevEnd
	 *            is the standard deviation at the end of the trend series. This
	...
	public double[] getGaussianTrend(int number, double avgStart,
		...
		for (int index = 0; index < number; index++) {
			values[index] = getGaussian(index * mAvg + nAvg, index * mStdDev
					+ nStdDev);
			if (getDouble() < outlayerPropability) {
				values[index] = generateOutlayer(values[index], outlayerSize);
