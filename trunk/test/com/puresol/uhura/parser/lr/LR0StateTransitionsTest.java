...
public class LR0StateTransitionsTest {
	...
	public void test() {
		try {
			...
			assertTrue(transitions.getTransition(0, new Terminal("id")) == 5);
			assertTrue(transitions.getTransition(0, new Terminal("LPAREN")) == 4);
			...
			assertTrue(transitions.getTransition(4, new Terminal("id")) == 5);
			assertTrue(transitions.getTransition(4, new NonTerminal("E")) == 8);
			assertTrue(transitions.getTransition(4, new Terminal("LPAREN")) == 4);
			...
			assertTrue(transitions.getTransition(6, new Terminal("LPAREN")) == 4);
			assertTrue(transitions.getTransition(6, new Terminal("id")) == 5);

			assertEquals(3, transitions.getTransitions(7).size());
			assertTrue(transitions.getTransition(7, new NonTerminal("F")) == 10);
			assertTrue(transitions.getTransition(7, new Terminal("LPAREN")) == 4);
			assertTrue(transitions.getTransition(7, new Terminal("id")) == 5);

			assertEquals(2, transitions.getTransitions(8).size());
			assertTrue(transitions.getTransition(8, new Terminal("PLUS")) == 6);
			assertTrue(transitions.getTransition(8, new Terminal("RPAREN")) == 11);
