...
public class LR1StateTransitionsTest {
	...
	public void testLR1Grammar() {
		try {
			...
			assertTrue(transitions.getTransition(0, new Terminal("c", null,
					false)) == 3);
			assertTrue(transitions.getTransition(0, new Terminal("d", null,
					false)) == 4);
			...
			assertTrue(transitions.getTransition(2, new Terminal("c", null,
					false)) == 6);
			assertTrue(transitions.getTransition(2, new Terminal("d", null,
					false)) == 7);

			assertEquals(3, transitions.getTransitions(3).size());
			assertTrue(transitions.getTransition(3, new NonTerminal("C")) == 8);
			assertTrue(transitions.getTransition(3, new Terminal("c", null,
					false)) == 3);
			assertTrue(transitions.getTransition(3, new Terminal("d", null,
					false)) == 4);
			...
			assertTrue(transitions.getTransition(6, new Terminal("c", null,
					false)) == 6);
			assertTrue(transitions.getTransition(6, new Terminal("d", null,
					false)) == 7);
