...
public class ProgramWarning implements PropertyDescription<Integer> {
	...
	private static final Translator translator = Translator
			.getTranslator(ProgramWarning.class);
	...
	public String getDisplayName() {
		return translator.i18n("CodeDepth for Programs for Medium Quality");
	}

	@Override
	public String getDescription() {
		return translator
				.i18n("Specify here the codepth for programs to raise a warning.");
	}
