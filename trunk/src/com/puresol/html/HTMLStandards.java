...
public class HTMLStandards {
	...
	try {
	    ...
	    JOptionPane.showConfirmDialog(Application
		    .getInstance(), "Could not open link!",
		    "IO Error", JOptionPane.OK_OPTION,
    ...
    public static String convertTSVToTable(String report) {
	String result = report;
	result = result.replace("\n", "</td></tr><tr><td>");
	result = result.replace("\t", "</td><td>");
	return "<table><tr><td>" + result
		+ "</td></tr></table>";
    }
}
