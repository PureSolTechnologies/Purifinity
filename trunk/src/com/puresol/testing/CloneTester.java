...
public class CloneTester {
	...
	private static final Logger logger = Logger.getLogger(CloneTester.class);
	...
	public boolean checkObject() {
		if (clonedObject == object) {
			logger
					.error("Cloning was not successful! The reference was copied and original object and cloned object are the same!");
			return false;
		}
		...
		try {
			for (Field field : fields) {
				...
				if (originalValue == clonedValue) {
					logger
							.error("Cloning was not successful for field "
									+ field.getName()
