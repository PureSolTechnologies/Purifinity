...
public class IntervalException extends Exception {
    ...
    private static final Translator translator =
	    Translator.getTranslator(IntervalException.class);

    public IntervalException(double leftEdge, double rightEdge) {
	super(translator.i18n("Interval ({0}, {1}) is not suitable!",
		leftEdge, rightEdge));
    }
	...
	super(
		translator
			.i18n(
				"Interval ({0}, {1}) is not suitable because of edge function values ({2},{3})!",
	...
	super(
		translator
			.i18n(
				"Interval ({0}, {1}) is not suitable to find value {2} because of edge function values ({3},{4})!",
