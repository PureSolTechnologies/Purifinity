...
public class Instances {
     ...
     *            is the class to be intatiated.
     * @param params
     *            is an array of parameters to be passed to the
     *            constructor.
    ...
    public static <C, R> R runStaticMethod(Class<C> clazz,
	    String methodName, Class<R> returnType, Object... params)
	    throws MethodInvokationException {
	Class<?>[] parameterClasses = params2Classes(params);
	try {
		...
		throw new NoSuchMethodException("Return type "
			...
			+ " is invalid for " + returnType.getName() + "!");
	    }
