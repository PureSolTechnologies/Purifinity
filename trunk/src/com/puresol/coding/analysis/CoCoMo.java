...
/**
 * This class calculates the CoCoMo for a set number of sloc and a given
 * average salary and complexity.
 * 
 * @author Rick-Rainer Ludwig
 * 
 */
public class CoCoMo {
    ...
    private static final Translator translator =
	    Translator.getTranslator(CoCoMo.class);
	...
	text +=
		translator.i18n(
			"Calculation for a {0} complexity project.",
