...
public class SLOCReport {
	...
	public static String getLineCountReport(AbstractSLOCMetric sloc) {
	...
	public static String getHTMLLineCountReport(AbstractSLOCMetric sloc) {
		return HTMLStandards.convertTSVToTable(getLineCountReport(sloc));
	}

	public static String getLineLengthReport(AbstractSLOCMetric sloc) {
	...
	public static String getHTMLLineLengthReport(AbstractSLOCMetric sloc) {
		return HTMLStandards.convertTSVToTable(getLineLengthReport(sloc));
	}

	public static String getHTMLReport(AbstractSLOCMetric sloc) {
