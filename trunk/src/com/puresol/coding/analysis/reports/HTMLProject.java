...
public class HTMLProject {
	...
	return HTMLMetricsProject.create(Files.addPaths(directory,
		new File("metrics")), analyser);
    }
	...
	html +=
		"<a href=\"start.html\" target=\"desktop\">Home</a>";
	html +=
		" | <a href=\"metrics/index.html\" target=\"desktop\">Metrics</a>";
	html +=
		" | <a href=\"duplications/index.html\" target=\"desktop\">Duplications</a>";
