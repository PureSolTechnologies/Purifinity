...
public class HTMLAnalysisProject {
	...
	private Hashtable<File, String> fileIndex = new Hashtable<File, String>();
	private Hashtable<CodeRange, String> codeRangeIndex = new Hashtable<CodeRange, String>();
	...
	private static final Logger logger = Logger
			.getLogger(HTMLAnalysisProject.class);
	...
	private boolean createCodeRangeIndizes(File directory) {
		for (File file : analyser.getFiles()) {
			...
			for (CodeRange range : ranges) {
				...
				html += "<tr>\n";
				html += "<td>" + index + "</td>";
				QualityLevel level = analyser.getMetrics(file, range)
						.getQualityLevel();
				if (level == QualityLevel.HIGH) {
					html += "<td bgcolor=\"green\">";
				} else if (level == QualityLevel.MEDIUM) {
