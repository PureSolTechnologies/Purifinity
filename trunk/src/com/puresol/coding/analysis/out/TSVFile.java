...
public class TSVFile {
	...
	private void processCodeRange(VerticalData data, File file, CodeRange range) {
		CodeRangeMetrics metrics = analyser.getMetrics(file, range);
		...
		AbstractMaintainabilityIndex maintainability = metrics
		...
		data.addRow(file, range.getType().getName(), range.getName(), phyLOC,
				proLOC, comLOC, blLOC, vG, n1, N1, n2, N2, n, N, HL, HV, D, L,
				E, T, B, MIwoc, MIcw, MI);
	}
}
