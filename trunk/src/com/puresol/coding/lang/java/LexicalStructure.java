...
public class LexicalStructure {
	...
	public static final String NOT_STAR_NOT_SLASH = "([^*/]|" + LINE_TERMINATOR
			+ ")";
	 ...
	 * 3.8 Identifiers
	 ********************************/
	public static final String JAVA_LETTER_OR_DIGIT = "\\w"; /*
															 * TODO Check for
															 * UNITCODE!
															 */
	public static final String JAVA_LETTER = "\\D";
	...
	public static final String DIGIT = "(0|" + NON_ZERO_DIGIT + ")";
	public static final String DIGITS = DIGIT + "+";
	public static final String DECIMAL_NUMERAL = "(0|" + NON_ZERO_DIGIT + "("
			+ DIGITS + ")?)";
