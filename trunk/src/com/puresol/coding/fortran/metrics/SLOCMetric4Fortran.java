...
package com.puresol.coding.fortran.metrics;
 ...
 * 
 */
public class SLOCMetric4Fortran extends AbstractSLOCMetric {

    public SLOCMetric4Fortran(CodeRange codeRange) {
	super(codeRange);
    }
