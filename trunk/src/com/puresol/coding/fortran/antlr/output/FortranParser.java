...
public class FortranParser extends Parser {
    public static final String[] tokenNames =
	    new String[] { "<invalid>", "<EOR>", "<DOWN>", "<UP>", "S",
		    "U", "B", "R", "O", "T", "I", "N", "E", "SUBROUTINE",
		    "G", "INTEGER", "A", "L", "REAL", "F", "IF", "H",
		    "THEN", "D", "WS", "END_IF", "DOLLAR", "COMMA",
		    "LPAREN", "RPAREN", "COLON", "ASSIGN", "MINUS",
		    "PLUS", "DIV", "POWER", "STAR", "LNOT", "LAND", "LOR",
		    "Q", "V", "EQV", "NEQV", "X", "XOR", "EOR", "LT",
		    "LE", "GT", "GE", "NE", "EQ", "TRUE", "FALSE", "ID",
		    "INT_CONST", "HEX_DIGIT", "HEX_CONST", "EXPONENT",
		    "FLOAT_CONST", "LINEFEED", "COMMENT", "NOTNL",
		    "ESC_SEQ", "STRING_CONST", "CHAR_CONST",
		    "UNICODE_ESC", "OCTAL_ESC", "C", "J", "K", "M", "P",
		    "W", "Y", "Z" };
	...
	return "/home/ludwig/privat/PureSolTechnologiesAPI/src/com/puresol/coding/fortran/antlr/FortranParser.g";
    }
    ...
    // $ANTLR start "file"
    // /home/ludwig/privat/PureSolTechnologiesAPI/src/com/puresol/coding/fortran/antlr/FortranParser.g:30:1:
    // file : (~ WS | WS )* ;
    public final void file() throws RecognitionException {
	try {
	    // /home/ludwig/privat/PureSolTechnologiesAPI/src/com/puresol/coding/fortran/antlr/FortranParser.g:30:6:
	    // ( (~ WS | WS )* )
	    // /home/ludwig/privat/PureSolTechnologiesAPI/src/com/puresol/coding/fortran/antlr/FortranParser.g:30:8:
	    // (~ WS | WS )*
	    {
		// /home/ludwig/privat/PureSolTechnologiesAPI/src/com/puresol/coding/fortran/antlr/FortranParser.g:30:8:
		// (~ WS | WS )*
    ...
    public static final BitSet FOLLOW_set_in_file49 =
	    new BitSet(new long[] { 0xFFFFFFFFFFFFFFF2L,
		    0x0000000000001FFFL });
