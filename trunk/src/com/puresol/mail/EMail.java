...
public class EMail {
	...
	public EMail(String[] tos, String from, String mailServer, String subject) {
	...
	public static void main(String[] args) {
		EMail sm = new EMail("Ludwig@puresol-technologies.com",
				"contact@puresol-technologies.com", "smtp.web.de", "test email");
