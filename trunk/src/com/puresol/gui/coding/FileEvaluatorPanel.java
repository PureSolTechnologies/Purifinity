...
public class FileEvaluatorPanel extends Panel {
	...
	private static final Translator translator = Translator
			.getTranslator(FileEvaluatorPanel.class);
	...
	public FileEvaluatorPanel() {
		super();
		initUI();
	}

	public FileEvaluatorPanel(ProjectAnalyzer projectAnalyser) {
		super();
	...
	private void addEvaluators() {
		synchronized (evaluators) {
			List<FileEvaluatorFactory> evaluatorFactories = Evaluators
					.getInstance().getFileEvaluators();
