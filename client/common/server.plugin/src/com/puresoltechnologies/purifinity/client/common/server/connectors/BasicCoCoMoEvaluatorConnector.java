...
public class BasicCoCoMoEvaluatorConnector implements EvaluatorStore {

	public static EvaluatorStore getStore() {
		BundleContext bundleContext = Activator.getDefault().getBundle()
				.getBundleContext();
		ServiceReference<BasicCoCoMoEvaluatorConnector> serviceReference = bundleContext
				.getServiceReference(BasicCoCoMoEvaluatorConnector.class);
