...
public class IntermediateCoCoMoEvaluatorConnector implements EvaluatorStore {

	public static EvaluatorStore getStore() {
		BundleContext bundleContext = Activator.getDefault().getBundle()
				.getBundleContext();
		ServiceReference<IntermediateCoCoMoEvaluatorConnector> serviceReference = bundleContext
				.getServiceReference(IntermediateCoCoMoEvaluatorConnector.class);
