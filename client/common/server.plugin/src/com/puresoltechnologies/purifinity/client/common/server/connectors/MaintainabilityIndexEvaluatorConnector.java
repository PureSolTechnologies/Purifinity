...
public class MaintainabilityIndexEvaluatorConnector implements EvaluatorStore {
	...
	public static EvaluatorStore getStore() {
		BundleContext bundleContext = Activator.getDefault().getBundle()
				.getBundleContext();
		ServiceReference<MaintainabilityIndexEvaluatorConnector> serviceReference = bundleContext
				.getServiceReference(MaintainabilityIndexEvaluatorConnector.class);
