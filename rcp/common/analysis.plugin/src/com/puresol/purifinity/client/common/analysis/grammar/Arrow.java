...
public class Arrow {
	...
	Color foregroundColor = graphics.getForeground();
	...
	if (type == ArrowType.SIMPLE) {
	    ...
	    int polygon[] = new int[] { x2, y2, leftPointX, leftPointY,
		    rightPointX, rightPointY, x2, y2 };
	    ...
	    int polygon[] = new int[] { x2, y2, leftPointX, leftPointY,
		    centerPointX, centerPointY, rightPointX, rightPointY, x2,
		    y2 };
	    graphics.fillPolygon(polygon);
	}
