...
public class TemplateElement implements Serializable {
    ...
    public int getId() {
	return getter.getAnnotation(TemplateElementLayout.class).id();
    }
	...
	return getter.getAnnotation(TemplateElementLayout.class).optional();
    }

    public boolean isHidden() {
	return getter.getAnnotation(TemplateElementLayout.class).hidden();
    }
