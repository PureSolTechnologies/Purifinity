...
public class RTAParser {
	...
	private static final Logger logger = Logger.getLogger(RTAParser.class);
	 ...
	 */
	private Vector<String> switchList;
	 ...
	 */
	private Vector<String> freeParameterList;
	...
	public void readStandardSwitches() {
		...
		if (logLevel.equalsIgnoreCase("trace")) {
			...
			logger.warn("Log level '" + logLevel
					+ "' is unknown or not allowed to be set."
