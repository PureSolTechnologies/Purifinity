...
/**
 * This is a special parameter for style issues. The generic for
 ...
 */
public class StyleIssueParameter extends ParameterWithArbitraryUnit<Integer> {

    public static StyleIssueParameter create(String parameterName, String parameterUnit, String parameterDescription) {
	return new StyleIssueParameter(parameterName, parameterUnit, parameterDescription);
    }

    private static final long serialVersionUID = -2759994739756661433L;

    @JsonCreator
    public StyleIssueParameter(@JsonProperty("name") String name, @JsonProperty("unit") String unit,
