...
public interface ProjectMetrics extends Metrics {
	...
	/**
	 * This method returns the {@link UUID} of the project for which the metrics
	 * are for.
	 * 
	 * @return An {@link UUID} object is returned containing the UUID.
	 */
	public UUID getProjectUUID();

	/**
	 * This method returns the {@link UUID} of the run for which the metrics are
	 * for.
	 * 
	 * @return An {@link UUID} object is returned containing the UUID.
	 */
