...
public class MetricParameter<T extends Number & Serializable & Comparable<T>>
	...
	if (type.equals(Double.class)) {
	    return new MetricParameter<Double>(parameterName, parameterUnit,
		    levelOfMeasurement, parameterDescription, Double.class);
	} else if (type.equals(Float.class)) {
	    return new MetricParameter<Float>(parameterName, parameterUnit,
		    levelOfMeasurement, parameterDescription, Float.class);
	} else if (type.equals(Byte.class)) {
	    return new MetricParameter<Byte>(parameterName, parameterUnit,
		    levelOfMeasurement, parameterDescription, Byte.class);
	} else if (type.equals(Short.class)) {
	    return new MetricParameter<Short>(parameterName, parameterUnit,
		    levelOfMeasurement, parameterDescription, Short.class);
	} else if (type.equals(Integer.class)) {
	    return new MetricParameter<Integer>(parameterName, parameterUnit,
		    levelOfMeasurement, parameterDescription, Integer.class);
	} else if (type.equals(Long.class)) {
	    return new MetricParameter<Long>(parameterName, parameterUnit,
		    levelOfMeasurement, parameterDescription, Long.class);
	} else {
	    return new MetricParameter<Double>(parameterName, parameterUnit,
		    levelOfMeasurement, parameterDescription, Double.class);
	}
