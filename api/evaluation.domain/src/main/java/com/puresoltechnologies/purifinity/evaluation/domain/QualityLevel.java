...
public class QualityLevel implements Comparable<QualityLevel>, Serializable {
     ...
     * 
     * @param quality
     *            is the {@link SourceCodeQuality} to be converted into a
     *            decimal representation.
     * @return A double value is returned with a decimal representation of this
     *         level.
     */
	...
	case LOW:
	    ...
	    break;
	default:
	    throw new IllegalArgumentException("Quality '" + quality.name()
		    + "' is not supported or know. The quality level needs to be specfied explicitly. UNSPECIFIED is not supported.");
	}
	return level;
    }

    public static QualityLevel combine(QualityLevel overallQualityLevel, QualityLevel qualityLevel) {
