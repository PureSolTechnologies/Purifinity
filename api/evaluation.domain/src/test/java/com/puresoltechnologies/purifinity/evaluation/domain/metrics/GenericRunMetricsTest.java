...
public class GenericRunMetricsTest {
	...
	GenericRunMetrics metrics = new GenericRunMetrics("evaluatorId",
		new Version(1, 2, 3), new Date(),
		new HashSet<MetricParameter<?>>(),
		new HashMap<HashId, GenericFileMetrics>(),
		new HashMap<HashId, GenericDirectoryMetrics>());
	String serialized = JSONSerializer.toJSONString(metrics);
	System.out.println(serialized);
	GenericRunMetrics deserialized = JSONSerializer.fromJSONString(
		serialized, GenericRunMetrics.class);
