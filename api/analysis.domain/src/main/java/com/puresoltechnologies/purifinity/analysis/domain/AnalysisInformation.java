...
public final class AnalysisInformation implements Serializable, TimeAwareness {
	...
	public AnalysisInformation(HashId hashId, Date startTime, long duration,
			...
			String analyzerId, Version pluginVersion) {
		this(hashId, startTime, duration, successful, languageName,
				languageVersion, analyzerId, pluginVersion, null);
	}
	...
	public AnalysisInformation(@JsonProperty("hashId") HashId hashId,
			...
			@JsonProperty("analyzerId") String analyzerId,
			@JsonProperty("analyzerVersion") Version analyzerVersion,
		...
		result = prime
				* result
				+ ((analyzerErrorMessage == null) ? 0 : analyzerErrorMessage
						.hashCode());
		result = prime * result
				+ ((analyzerId == null) ? 0 : analyzerId.hashCode());
		result = prime * result
				+ ((analyzerVersion == null) ? 0 : analyzerVersion.hashCode());
