...
public final class CodeAnalysis implements Serializable, TimeAwareness {
    ...
    public CodeAnalysis(Date time, long duration, String languageName, String languageVersion,
	    AnalysisInformation analysisInformation, List<CodeRange> analyzableCodeRanges,
     ...
     * 
     * @return A {@link Date} is returned containing the start time of the
     *         analysis.
     */
    @Override
	...
	final int prime = 31;
	int result = 1;
	result = prime * result + ((analyzableCodeRanges == null) ? 0 : analyzableCodeRanges.hashCode());
	result = prime * result + ((analysisInformation == null) ? 0 : analysisInformation.hashCode());
	result = prime * result + (int) (duration ^ (duration >>> 32));
	result = prime * result + ((time == null) ? 0 : time.hashCode());
	result = prime * result + ((universalSyntaxTree == null) ? 0 : universalSyntaxTree.hashCode());
	return result;
    }
