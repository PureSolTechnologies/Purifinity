...
public class ResourceUtils {
     ...
     */
    public static void addResources(JavaArchive javaArchive, File directory, Filter<File> filter) {
	for (File entry : ResourceUtils.findResourcesRecursively(directory, filter)) {
	    javaArchive.addAsResource(entry, directory.toURI().relativize(entry.toURI()).getPath());
	}
    }
     ...
     *         recognized files.
     */
    static List<File> findResourcesRecursively(File directory, Filter<File> filter) {
