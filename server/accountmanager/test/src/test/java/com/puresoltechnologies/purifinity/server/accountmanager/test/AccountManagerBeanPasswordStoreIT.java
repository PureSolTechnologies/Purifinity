...
public class AccountManagerBeanPasswordStoreIT extends AbstractAccountManagerServerTest {
     ...
     *             is thrown in case of password activation issues.
     */
    ...
    public void testCreateAccountTooWeakPassword() throws AccountManagerException, PasswordCreationException {
	...
	accountManager.createAccount(EMAIL_ADDRESS, EMAIL_ADDRESS.getAddress(), "engineer");
	assertFalse(
		passwordStoreClient.authenticate(EMAIL_ADDRESS, new Password(VALID_PASSWORD.getPassword() + "Wrong!")));
    }

    @Test
    public void testChangePassword() throws AccountManagerException, PasswordChangeException, PasswordCreationException,
	...
	assertTrue(accountManager.changePassword(EMAIL_ADDRESS, VALID_PASSWORD, new Password(newPassword)));
	...
	accountManager.createAccount(EMAIL_ADDRESS, EMAIL_ADDRESS.getAddress(), "engineer");
	assertTrue(passwordStoreClient.authenticate(EMAIL_ADDRESS, VALID_PASSWORD));
	assertFalse(accountManager.changePassword(EMAIL_ADDRESS, new Password(VALID_PASSWORD.getPassword() + "Wrong!"),
    ...
    @Test
    public void testResetPassword() throws AccountManagerException, PasswordResetException, PasswordCreationException,
	    PasswordActivationException {
	String activationKey = accountManager.createPassword(EMAIL_ADDRESS, VALID_PASSWORD);
	accountManager.activatePassword(EMAIL_ADDRESS, activationKey);
	accountManager.createAccount(EMAIL_ADDRESS, EMAIL_ADDRESS.getAddress(), "engineer");
