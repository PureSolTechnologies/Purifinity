...
public class HBaseElementNames {
    ...
    public static final String PLUGIN_PREFERENCES_TABLE = "preferences_store_plugin_preferences";
    public static final String PLUGIN_DEFAULTS_PREFERENCES_TABLE = "preferences_store_plugin_default_preferences";
