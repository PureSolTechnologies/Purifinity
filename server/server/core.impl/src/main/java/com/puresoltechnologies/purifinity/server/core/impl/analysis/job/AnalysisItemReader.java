...
public class AnalysisItemReader extends AbstractItemReader {
	...
	public void open(Serializable checkpoint) throws Exception {
		...
		if (checkpoint != null) {
			...
			this.checkpoint = new AnalysisCheckpoint(
					analysisJobContext.getStoredFiles());
		}
		stepContext.setPersistentUserData(new PersistentStepUserData(
				"File Analysis", "The files in projects are analyzed.",
