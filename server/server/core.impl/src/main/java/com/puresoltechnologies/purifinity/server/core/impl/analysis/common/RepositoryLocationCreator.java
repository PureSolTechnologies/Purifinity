...
public class RepositoryLocationCreator {

	public static RepositoryLocation createFromSerialization(
		...
		try {
			...
			RepositoryLocation repositoryLocation = (RepositoryLocation) repositoryConstructor
