...
import static com.puresoltechnologies.purifinity.server.core.impl.evaluation.metrics.normmaint.NormalizedMaintainabilityIndexEvaluatorParameter.ALL;
import static com.puresoltechnologies.purifinity.server.core.impl.evaluation.metrics.normmaint.NormalizedMaintainabilityIndexEvaluatorParameter.CODE_RANGE_NAME;
import static com.puresoltechnologies.purifinity.server.core.impl.evaluation.metrics.normmaint.NormalizedMaintainabilityIndexEvaluatorParameter.CODE_RANGE_TYPE;
import static com.puresoltechnologies.purifinity.server.core.impl.evaluation.metrics.normmaint.NormalizedMaintainabilityIndexEvaluatorParameter.NORM_MI;
import static com.puresoltechnologies.purifinity.server.core.impl.evaluation.metrics.normmaint.NormalizedMaintainabilityIndexEvaluatorParameter.NORM_MI_CW;
import static com.puresoltechnologies.purifinity.server.core.impl.evaluation.metrics.normmaint.NormalizedMaintainabilityIndexEvaluatorParameter.NORM_MI_WOC;
import static com.puresoltechnologies.purifinity.server.core.impl.evaluation.metrics.normmaint.NormalizedMaintainabilityIndexEvaluatorParameter.QUALITY;
import static com.puresoltechnologies.purifinity.server.core.impl.evaluation.metrics.normmaint.NormalizedMaintainabilityIndexEvaluatorParameter.QUALITY_LEVEL;
import static com.puresoltechnologies.purifinity.server.core.impl.evaluation.metrics.normmaint.NormalizedMaintainabilityIndexEvaluatorParameter.SOURCE_CODE_LOCATION;
