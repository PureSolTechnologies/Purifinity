...
import com.puresoltechnologies.purifinity.evaluation.domain.defects.Defect;
...
@Stateless
public class EvaluatorDefectStoreServiceBean
	implements EvaluatorDefectsStoreService, EvaluatorDefectsStoreServiceRemote {
	...
	try (PreparedStatement preparedStatement = connection.prepareStatement("SELECT hashid FROM "
		+ HBaseElementNames.EVALUATION_DEFECTS_TABLE
	...
	try (PreparedStatement preparedStatement = connection.prepareStatement("SELECT hashid FROM "
		+ HBaseElementNames.EVALUATION_DEFECTS_TABLE + " WHERE hashid=? AND evaluator_id=?")) {
	    preparedStatement.setString(1, hashId.toString());
    ...
    @Override
    public void storeFileResults(AnalysisRun analysisRun, CodeAnalysis codeAnalysis, FileDefects results)
	    throws EvaluationStoreException {
	try (PreparedStatement preparedStatement = connection.prepareStatement("UPSERT INTO "
		+ HBaseElementNames.EVALUATION_DEFECTS_TABLE + " (time, " + "hashid, " + "source_code_location, "
		...
		for (DefectParameter parameter : results.getParameters()) {
		    ...
		    List<Defect> defects = codeRangeIssues.getIssues(parameter);
		    if (defects == null) {
    ...
    @Override
    public void storeDirectoryResults(AnalysisRun analysisRun, AnalysisFileTree directory, DirectoryDefects results)
	    throws EvaluationStoreException {
	throwUnsupportedException();
    }

    @Override
    public void storeProjectResults(AnalysisRun analysisRun, AnalysisFileTree directory, ProjectDefects results)
	    throws EvaluationStoreException {
	throwUnsupportedException();
    }

    @Override
    public FileDefects readFileResults(HashId hashId, String evaluatorId) throws EvaluationStoreException {
    ...
    @Override
    public DirectoryDefects readDirectoryResults(HashId hashId, String evaluatorId) throws EvaluationStoreException {
	throwUnsupportedException();
	return null;
    }

    @Override
    public ProjectDefects readProjectResults(String projectId, long runId, String evaluatorId)
	    throws EvaluationStoreException {
	throwUnsupportedException();
	return null;
    }
    ...
    @Override
    public void storeFileResultsInBigTable(AnalysisRun analysisRun, CodeAnalysis codeAnalysis, FileDefects results)
	    throws EvaluationStoreException {
    ...
    public void storeDirectoryResultsInBigTable(AnalysisRun analysisRun, AnalysisFileTree directory,
	    DirectoryDefects results) throws EvaluationStoreException {
	throwUnsupportedException();
    }

    @Override
    public void storeProjectResultsInBigTable(AnalysisRun analysisRun, AnalysisFileTree directory,
	    ProjectDefects metrics) throws EvaluationStoreException {
	throwUnsupportedException();
    }

    @Override
    public RunDefects readRunResults(String projectId, long runId, String evaluatorId) throws EvaluationStoreException {
	throwUnsupportedException();
	return null;
    }
