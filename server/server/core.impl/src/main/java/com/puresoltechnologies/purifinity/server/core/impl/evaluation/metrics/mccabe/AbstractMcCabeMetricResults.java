...
import static com.puresoltechnologies.purifinity.server.core.impl.evaluation.metrics.mccabe.McCabeMetricEvaluatorParameter.CODE_RANGE_NAME;
import static com.puresoltechnologies.purifinity.server.core.impl.evaluation.metrics.mccabe.McCabeMetricEvaluatorParameter.CODE_RANGE_TYPE;
import static com.puresoltechnologies.purifinity.server.core.impl.evaluation.metrics.mccabe.McCabeMetricEvaluatorParameter.QUALITY;
import static com.puresoltechnologies.purifinity.server.core.impl.evaluation.metrics.mccabe.McCabeMetricEvaluatorParameter.QUALITY_LEVEL;
import static com.puresoltechnologies.purifinity.server.core.impl.evaluation.metrics.mccabe.McCabeMetricEvaluatorParameter.SOURCE_CODE_LOCATION;
import static com.puresoltechnologies.purifinity.server.core.impl.evaluation.metrics.mccabe.McCabeMetricEvaluatorParameter.VG;
