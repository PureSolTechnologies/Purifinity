...
public interface FileStoreServiceRemote extends FileStore {
    ...
    public static final String JNDI_NAME = "java:global/server.app/server.core.impl/FileStoreServiceImpl!com.puresoltechnologies.purifinity.server.core.api.analysis.FileStoreServiceRemote";
