...
public interface AnalysisStore {
    ...
    /**
     * This method returns a list of all {@link AnalysisProject}s.
     * 
     * @throws AnalysisStoreException
     ...
     * @return The {@link AnalysisProjectSettings} are returned.
     * @throws AnalysisStoreException
     *             is thrown in case of analysis store issues.
     */
     ...
     * @return The {@link FileSearchConfiguration} is returned.
     * @throws AnalysisStoreException
     *             is thrown in case of analysis store issues.
     */
