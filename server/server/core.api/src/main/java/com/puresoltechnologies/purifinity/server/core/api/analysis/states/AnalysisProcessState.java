...
public enum AnalysisProcessState implements
	...
	@Override
	public String getDescription() {
	    return "The analysis process was requested to abort.";
	}

	@Override
	public Set<AnalysisProcessTransition> getTransitions() {
	    HashSet<AnalysisProcessTransition> transitions = new HashSet<AnalysisProcessTransition>();
	    transitions.add(AnalysisProcessTransition.ABORT);
	    return transitions;
	}
    },
    ABORTED {
