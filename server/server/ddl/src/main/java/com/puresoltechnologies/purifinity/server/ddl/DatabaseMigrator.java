...
import com.puresoltechnologies.purifinity.server.ddl.accountmanager.AccountManagerDatabaseMigrator;
...
public class DatabaseMigrator {
    ...
    private static void dropTitanKeyspace(CassandraMigrationConnector connector) {
	...
	PluginsDatabaseMigrator pluginsDatabaseMigrator = new PluginsDatabaseMigrator(
		CASSANDRA_HOST, CASSANDRA_CQL_PORT);
	AccountManagerDatabaseMigrator accountManagerDatabaseMigrator = new AccountManagerDatabaseMigrator();
	if (drop) {
