 ...
 */
function addAngularJSExt(angularApplication) {
	angularApplication.controller("menuCtrl", menuCtrl);
}
 ...
 * 
 * @param $scope is injected
 * @param $route is injected
 * @param $routeParams is injected
 * @param $location is injected
 */
