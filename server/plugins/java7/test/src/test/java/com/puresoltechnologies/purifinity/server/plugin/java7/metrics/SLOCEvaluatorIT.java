...
public class SLOCEvaluatorIT extends AbstractMetricTest {
	...
	private void checkEvaluationResults(GenericFileMetrics fileResults) {
		...
		assertEquals(SourceCodeQuality.HIGH,
				result0.getValue(SourceCodeQualityParameter.getInstance())
						.getValue());
		...
		assertEquals(SourceCodeQuality.HIGH,
				result1.getValue(SourceCodeQualityParameter.getInstance())
						.getValue());
		...
		assertEquals(SourceCodeQuality.HIGH,
				result2.getValue(SourceCodeQualityParameter.getInstance())
						.getValue());
		...
		assertEquals(SourceCodeQuality.HIGH,
				result3.getValue(SourceCodeQualityParameter.getInstance())
						.getValue());
	}
}
