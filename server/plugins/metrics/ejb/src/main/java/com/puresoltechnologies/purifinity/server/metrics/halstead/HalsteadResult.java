...
public class HalsteadResult implements Serializable {
    ...
    public HalsteadResult(Map<String, Integer> operators,
	    Map<String, Integer> operands, int differentOperators,
	    int differentOperands, int totalOperators, int totalOperands,
	    int vocabularySize, int programLength, double halsteadLength,
	    double halsteadVolume, double difficulty, double programLevel,
	    double implementationEffort, double implementationTime,
