...
@Singleton
public class IntermediateCoCoMoServiceRegistration extends AbstractEvaluatorServiceRegistration {
    ...
    private static final EvaluatorServiceInformation INFORMATION = new EvaluatorServiceInformation(
	    IntermediateCoCoMoEvaluator.ID, IntermediateCoCoMoEvaluator.NAME, EvaluatorType.METRICS,
	    IntermediateCoCoMoEvaluator.PLUGIN_VERSION, JNDI_ADDRESS, IntermediateCoCoMoEvaluator.DESCRIPTION,
	    IntermediateCoCoMoEvaluator.PARAMETERS, "/metrics.ui/intermediate-cocomo/index.jsf",
	    "/metrics.ui/intermediate-cocomo/project.jsf", "/metrics.ui/intermediate-cocomo/run.jsf",
	    IntermediateCoCoMoEvaluator.EVALUATED_QUALITY_CHARACTERISTICS, IntermediateCoCoMoEvaluatorParameter.ALL,
