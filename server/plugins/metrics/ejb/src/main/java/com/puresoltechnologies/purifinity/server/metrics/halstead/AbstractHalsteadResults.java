...
import static com.puresoltechnologies.purifinity.server.metrics.halstead.HalsteadMetricEvaluatorParameter.QUALITY;
import static com.puresoltechnologies.purifinity.server.metrics.halstead.HalsteadMetricEvaluatorParameter.QUALITY_LEVEL;
			...
			if (quality != SourceCodeQuality.UNSPECIFIED) {
				...
				if (getQualityLevel() != null) {
					row.put(QUALITY.getName(),
							new MetricValue<SourceCodeQuality>(
