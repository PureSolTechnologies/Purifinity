...
public class SLOCEvaluatorParameter {
	...
	public static final MetricParameter<Integer> PHY_LOC = new MetricParameter<Integer>(
			"phyLOC", "", LevelOfMeasurement.RATIO,
			"Number pf physical lines of code.", Integer.class);
	public static final MetricParameter<Integer> PRO_LOC = new MetricParameter<Integer>(
			"proLOC", "", LevelOfMeasurement.RATIO,
			"Number of productive lines of code.", Integer.class);
	public static final MetricParameter<Integer> COM_LOC = new MetricParameter<Integer>(
			"comLOC", "", LevelOfMeasurement.RATIO,
			"Number of comments lines of code.", Integer.class);
	public static final MetricParameter<Integer> BL_LOC = new MetricParameter<Integer>(
			"blLOC", "", LevelOfMeasurement.RATIO,
			"Number of blank lines of code.", Integer.class);

	public static final MetricParameter<Integer> MIN = new MetricParameter<Integer>(
			"minLineLength", "", LevelOfMeasurement.RATIO,
			"Minimal source code line length.", Integer.class);
	public static final MetricParameter<Integer> MAX = new MetricParameter<Integer>(
			"maxLineLength", "", LevelOfMeasurement.RATIO,
			"Maximal source code line length.", Integer.class);
	public static final MetricParameter<Double> AVG = new MetricParameter<Double>(
			"avgLineLength", "", LevelOfMeasurement.RATIO,
			"Average of source code line lengths.", Double.class);
	public static final MetricParameter<Double> MEDIAN = new MetricParameter<Double>(
			"medLineLength", "", LevelOfMeasurement.RATIO,
			"Median of source code line lengths.", Double.class);
	public static final MetricParameter<Double> STD_DEV = new MetricParameter<Double>(
