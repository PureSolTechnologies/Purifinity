...
@Singleton
@Startup
public class SubversionRepositoryRegistration extends AbstractRepositoryServiceRegistration {

    @PostConstruct
    public void registraion() {
	register(RepositoryServiceManagerRemote.class, RepositoryServiceManagerRemote.JNDI_NAME,
		SubversionRepositoryPlugin.INFORMATION, SubversionRepository.JNDI_ADDRESS,
