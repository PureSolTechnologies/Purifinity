...
public class PasswordStoreEvents {
	...
	public static Event createAccountActivatedEvent(String email,
			String activationKey) {
	...
	public static Event createUserAuthenticatedEvent(String email) {
		return new Event(COMPONENT, 5, EventType.USER_ACTION,
				EventSeverity.INFO, "User '" + email + "' was authenticated.")
				.setUserEmail(email);
	}

	public static Event createPasswordChangedEvent(String email) {
	...
	public static Event createPasswordResetEvent(String email) {
		return new Event(COMPONENT, 7, EventType.USER_ACTION,
				EventSeverity.INFO, "Password for user '" + email
						+ "' was reset.").setUserEmail(email);
	}

	public static Event createPasswordTooWeakErrorEvent(String email) {
		/*
	...
	public static Event createInvalidEmailAddressErrorEvent(String email) {
		/*
	...
	public static Event createAccountAlreadyExistsErrorEvent(String email) {
		/*
	...
	public static Event createPasswordEncryptionErrorEvent(String email,
	...
	public static Event createAccountAlreadyActivatedEvent(String email) {
	...
	public static Event createInvalidActivationKeyErrorEvent(String email) {
	...
	public static Event createUserAuthenticationFailedEvent(String email) {
		/*
