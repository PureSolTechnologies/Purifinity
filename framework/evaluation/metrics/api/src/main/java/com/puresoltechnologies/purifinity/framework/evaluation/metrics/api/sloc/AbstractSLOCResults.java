...
import static com.puresoltechnologies.purifinity.framework.evaluation.metrics.api.sloc.SLOCEvaluatorParameter.AVG;
import static com.puresoltechnologies.purifinity.framework.evaluation.metrics.api.sloc.SLOCEvaluatorParameter.BL_LOC;
import static com.puresoltechnologies.purifinity.framework.evaluation.metrics.api.sloc.SLOCEvaluatorParameter.CODE_RANGE_NAME;
import static com.puresoltechnologies.purifinity.framework.evaluation.metrics.api.sloc.SLOCEvaluatorParameter.CODE_RANGE_TYPE;
import static com.puresoltechnologies.purifinity.framework.evaluation.metrics.api.sloc.SLOCEvaluatorParameter.COM_LOC;
import static com.puresoltechnologies.purifinity.framework.evaluation.metrics.api.sloc.SLOCEvaluatorParameter.MAX;
import static com.puresoltechnologies.purifinity.framework.evaluation.metrics.api.sloc.SLOCEvaluatorParameter.MEDIAN;
import static com.puresoltechnologies.purifinity.framework.evaluation.metrics.api.sloc.SLOCEvaluatorParameter.MIN;
import static com.puresoltechnologies.purifinity.framework.evaluation.metrics.api.sloc.SLOCEvaluatorParameter.PHY_LOC;
import static com.puresoltechnologies.purifinity.framework.evaluation.metrics.api.sloc.SLOCEvaluatorParameter.PRO_LOC;
import static com.puresoltechnologies.purifinity.framework.evaluation.metrics.api.sloc.SLOCEvaluatorParameter.QUALITY;
import static com.puresoltechnologies.purifinity.framework.evaluation.metrics.api.sloc.SLOCEvaluatorParameter.QUALITY_LEVEL;
import static com.puresoltechnologies.purifinity.framework.evaluation.metrics.api.sloc.SLOCEvaluatorParameter.SOURCE_CODE_LOCATION;
import static com.puresoltechnologies.purifinity.framework.evaluation.metrics.api.sloc.SLOCEvaluatorParameter.STD_DEV;
