...
public class SourceCode implements Serializable, Cloneable {
    ...
    public static SourceCode read(File file) throws IOException {
    ...
    public static SourceCode read(InputStream inputStream, File file)
	    throws IOException {
    ...
    public static SourceCode read(Reader reader, File file) throws IOException {
	...
	while (true) {
		...
		code.addSourceCodeLine(new SourceCodeLine(file, lineNumber,
			line));
		break;
	    } else {
