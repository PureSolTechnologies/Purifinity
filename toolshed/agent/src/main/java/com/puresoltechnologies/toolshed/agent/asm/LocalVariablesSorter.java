package com.puresoltechnologies.toolshed.agent.asm;
...
public class LocalVariablesSorter extends MethodVisitor {
     ...
     * of size 1 is remapped to 'mapping[2*i]', while a local variable at index i of
     ...
     * variables added with {@link #newLocal}. This method can update these types in
     * place for the stack map frame being visited. The default implementation of
     * this method does nothing, i.e. a local variable added with {@link #newLocal}
     * will have the same type in all stack map frames. But this behavior is not
     * always the desired one, for instance if a local variable is added in the
