package com.puresol.purifinity.coding.lang.test.grammar;
...
public class TestLanguageGrammar extends AbstractLanguageGrammar {
    ...
    public static final String GRAMMAR_RESOURCE = "/com/puresol/purifinity/coding/lang/test/grammar/TestLanguage.g";
    static {
