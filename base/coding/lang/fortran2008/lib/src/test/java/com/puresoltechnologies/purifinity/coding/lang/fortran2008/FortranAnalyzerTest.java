...
public class FortranAnalyzerTest {
	...
	public void testEmptyProgram() throws Exception {
		test(new File("src/test/resources"),
				new File(
						"com/puresoltechnologies/coding/lang/fortran2008/samples/EmptyProgram.f"));
	}
	...
	public void testEmptySubroutine() throws Exception {
		test(new File("src/test/resources"),
				new File(
						"com/puresoltechnologies/coding/lang/fortran2008/samples/EmptySubroutine.f"));
	}
	...
	public void test2() throws Exception {
		test(new File("src/test/resources"),
				new File(
						"com/puresoltechnologies/coding/lang/fortran2008/samples/FortranTest.f"));
	}
	...
	public void testZGERC() throws Exception {
		test(new File("src/test/resources"),
				new File(
						"com/puresoltechnologies/coding/lang/fortran2008/samples/zgerc.f"));
	}
	...
	public void testNDTRAN() throws Exception {
		test(new File("src/test/resources"),
				new File(
						"com/puresoltechnologies/coding/lang/fortran2008/samples/ndtran.f"));
	}
}
