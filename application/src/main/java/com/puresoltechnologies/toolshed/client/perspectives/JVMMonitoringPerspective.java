...
public class JVMMonitoringPerspective extends AbstractPerspective {

    public JVMMonitoringPerspective() {
	super("JVM Monitoring");
    }
	...
	leftStack.openPart(new RunningJVMs());
