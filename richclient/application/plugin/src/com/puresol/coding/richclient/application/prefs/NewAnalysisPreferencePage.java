package com.puresol.coding.richclient.application.prefs;
...
public class NewAnalysisPreferencePage extends PreferencePage implements
	...
	public static final String LOCATION_INCLUDES_DEFAULT = "";
	public static final String LOCATION_EXCLUDES_DEFAULT = ".*\nbin\ntarget";
	public static final String FILE_INCLUDES_DEFAULT = "";
	public static final String FILE_EXCLUDES_DEFAULT = ".*\n*.bak\n*~";
	public static final boolean IGNORE_HIDDEN_DEFAULT = true;
	...
	public void init(IWorkbench workbench) {
		// setPreferenceStore(preferencesNode);
	}

	public static void setDefaultValuesToPreferencesStore(
			IEclipsePreferences preferenceStore) {
		preferenceStore.put(LOCATION_INCLUDES, LOCATION_INCLUDES_DEFAULT);
		preferenceStore.put(LOCATION_EXCLUDES, LOCATION_EXCLUDES_DEFAULT);
		preferenceStore.put(FILE_INCLUDES, FILE_INCLUDES_DEFAULT);
		preferenceStore.put(FILE_EXCLUDES, FILE_EXCLUDES_DEFAULT);
		preferenceStore.putBoolean(IGNORE_HIDDEN, IGNORE_HIDDEN_DEFAULT);
	}

	@Override
	public void performDefaults() {
		super.performDefaults();
		directoryIncludes.setText(LOCATION_INCLUDES_DEFAULT);
		directoryExcludes.setText(LOCATION_EXCLUDES_DEFAULT);
	...
	public boolean performOk() {
		...
		preferenceStore
				.setValue(LOCATION_INCLUDES, directoryIncludes.getText());
		preferenceStore
				.setValue(LOCATION_EXCLUDES, directoryExcludes.getText());
