...
import com.puresol.coding.analysis.api.storage.ModuleStoreFactory;
 ...
 * 
 */
public abstract class AbstractRCPEvaluator extends Job implements Evaluator {
	...
	public AbstractRCPEvaluator(String name, String description,
