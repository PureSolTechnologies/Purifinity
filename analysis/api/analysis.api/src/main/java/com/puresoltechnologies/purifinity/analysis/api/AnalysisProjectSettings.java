...
public final class AnalysisProjectSettings implements Serializable {
    ...
    /**
     * This field contains a path to a pre-analysis script which is run before
     * the actual analysis takes place to create additional content and logs.
     */
    private final File preAnalysisScript;
     ...
     */
    @JsonCreator
    public AnalysisProjectSettings(@JsonProperty("name") String name, //
	    @JsonProperty("description") String description, //
	    @JsonProperty("preAnalysisScript") File preAnalysisScript, //
	...
	this.preAnalysisScript = preAnalysisScript;
    ...
    /**
     * Thie method returns the path to the pre-analysis script.
     * 
     * @return A {@link File} is returned.
     */
    public final File getPreAnalysisScript() {
	return preAnalysisScript;
    }

    /**
     * This method returns the file search configuration.
     * 
     * @return A {@link FileSearchConfiguration} is returned. A relative path is
     *         relative to the project root directory. An absolute path is used
     *         as such.
     */
