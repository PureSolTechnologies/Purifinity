...
public class PreferencesStoreRestService implements PreferencesStoreRestInterface {
	...
	ConfigurationParameter<Object> configurationParameter = (ConfigurationParameter<Object>) findConfigurationParameter(
		key);
	Object o = TypeWrapper.convertFromString(configurationParameter.getType(), value);
	...
	ConfigurationParameter<Object> configurationParameter = (ConfigurationParameter<Object>) findConfigurationParameter(
		key);
	PreferencesValue<?> systemPreference = preferencesStore.getSystemPreference(configurationParameter);
    ...
    @Override
    public void setPluginDefaultParameter(String pluginId, String key, String value) {
	@SuppressWarnings("unchecked")
	ConfigurationParameter<Object> configurationParameter = (ConfigurationParameter<Object>) findPluginDefaultConfigurationParameter(
		pluginId, key);
	Object o = TypeWrapper.convertFromString(configurationParameter.getType(), value);
	preferencesStore.setPluginDefaultPreference(pluginId, configurationParameter, o);
    }
	...
	ConfigurationParameter<Object> configurationParameter = (ConfigurationParameter<Object>) findPluginDefaultConfigurationParameter(
		pluginId, key);
	PreferencesValue<?> pluginDefaultPreference = preferencesStore.getPluginDefaultPreference(pluginId,
    ...
    @Override
    public String getPluginProjectParameter(String projectId, String pluginId, String key) {
	@SuppressWarnings("unchecked")
	...
	PreferencesValue<?> pluginProjectPreference = preferencesStore.getPluginProjectPreference(projectId, pluginId,
		configurationParameter);
    ...
    @Override
    public void setPluginProjectParameter(String projectId, String pluginId, String key, String value) {
	@SuppressWarnings("unchecked")
	ConfigurationParameter<Object> configurationParameter = (ConfigurationParameter<Object>) findPluginProjectConfigurationParameter(
		projectId, pluginId, key);
	Object o = TypeWrapper.convertFromString(configurationParameter.getType(), value);
	preferencesStore.setPluginProjectPreference(projectId, pluginId, configurationParameter, o);
    }

    @Override
    public ConfigurationParameter<?>[] getUserParameters(String userId) {
	...
	for (ConfigurationParameter<?> configurationParameter : preferencesStore.getSystemParameters()) {
    ...
    private ConfigurationParameter<?> findPluginDefaultConfigurationParameter(String pluginId, String key) {
	ConfigurationParameter<?> parameter = null;
	for (ConfigurationParameter<?> configurationParameter : preferencesStore.getPluginDefaultParameters(pluginId)) {
	    if (configurationParameter.getPropertyKey().equals(key)) {
		parameter = configurationParameter;
	    }
	}
    ...
    private ConfigurationParameter<?> findPluginProjectConfigurationParameter(String projectId, String pluginId,
	    String key) {
	ConfigurationParameter<?> parameter = null;
	for (ConfigurationParameter<?> configurationParameter : preferencesStore.getPluginProjectParameters(projectId,
		pluginId)) {
	    if (configurationParameter.getPropertyKey().equals(key)) {
		parameter = configurationParameter;
	    }
