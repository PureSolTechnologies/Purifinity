...
@Singleton
@Startup
public class GITRepositoryRegistration extends AbstractRepositoryServiceRegistration {

    @PostConstruct
    public void registraion() {
	register(RepositoryServiceManagerRemote.class, RepositoryServiceManagerRemote.JNDI_NAME,
		GITRepositoryPlugin.INFORMATION, GITRepository.JNDI_ADDRESS, GITRepository.INFORMATION);
    }

    @PreDestroy
    public void unregistration() {
	unregister(RepositoryServiceManagerRemote.class, RepositoryServiceManagerRemote.JNDI_NAME,
