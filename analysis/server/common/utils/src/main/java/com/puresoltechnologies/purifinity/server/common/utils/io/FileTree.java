...
public class FileTree extends TreeNodeImpl<FileTree> implements Comparable<FileTree> {
    ...
    public static List<File> getFileListFromFileTree(File baseDirectory, FileTree fileTree) {
     ...
     * 
     * @param name
     *            is the name of the child to be returned.
     * @return A {@link FileTree} is returned containing the child.
     */
     ...
     *            False, does not.
     * @return A {@link String} for the path is returned.
     */
     ...
     *            return value an absolute path. True adds the root element.
     *            False, does not.
     * @return A {@link File} is presenting the path.
     */
