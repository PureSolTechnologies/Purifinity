...
public class RSAUtilities {
     ...
     *             is thrown if block size is invalid.
     * @throws InvalidKeyException
     *             is thrown in case the key is invalid.
     */
	...
	return StringUtils.convertByteArrayToString(privateKeySpec.getEncoded());
    }
     ...
     */
    public static KeyPair getKeyPairFromString(String publicKey, String privateKey) {
	...
	try {
	    byte[] privateEncoded = StringUtils.convertStringToByteArray(privateKey);
