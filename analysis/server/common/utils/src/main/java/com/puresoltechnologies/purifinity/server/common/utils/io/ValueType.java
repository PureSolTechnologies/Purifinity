...
public class ValueType implements Comparable<ValueType> {
     ...
     * @return <code>true</code> is returned if the stored variable type is
     *         equal to c. Otherwise false is returned.
     */
	...
	final int prime = 31;
	int result = 1;
	result = prime * result + ((classObject == null) ? 0 : classObject.hashCode());
	return result;
    }
