...
projectManagerModule.controller("createProjectCtrl", ["$scope", "$location", "$rootScope", "projectManager",
    function($scope, $location, $rootScope, projectManager) {
        $scope.items = {
            id: "",
            name: "",
            description: "",
            directoryIncludes: "",
            directoryExcludes: "bin\nbuild\ntarget\n.*",
            fileIncludes: "",
            fileExcludes: ".*\n*.bak\n*~\n#*#",
            ignoreHidden: true,
            repositoryId: "",
