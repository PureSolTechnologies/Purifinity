...
export class ProjectRunDesignComponent {
    ...
    constructor(private routeParams: RouteParams, private router: Router, private evaluatorStore: EvaluatorStore) {
        ...
        let component = this;
        evaluatorStore.getRunIssueDesignSeverities(this.projectId, this.runId,
            function(data: any) {
        ...
        evaluatorStore.getRunIssueDesignParameters(this.projectId, this.runId,
            function(data: any) {
