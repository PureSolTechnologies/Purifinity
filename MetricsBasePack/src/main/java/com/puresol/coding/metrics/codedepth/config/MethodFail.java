...
public class MethodFail implements PropertyDescription<Integer> {
	...
	private static final Translator translator = Translator
			.getTranslator(MethodFail.class);
	...
	public String getDisplayName() {
		return translator.i18n("CodeDepth for Methods for Low Quality");
	}

	@Override
	public String getDescription() {
		return translator.i18n("Specify here the codepth for methods to fail.");
	}
